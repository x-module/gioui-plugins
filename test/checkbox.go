...
func main() {
	...
	var girl = widgets.NewCheckBox(th, &widget.Bool{Value: false}, "handler")
	var boy = widgets.NewCheckBox(th, &widget.Bool{Value: true}, "handler")
	var three = widgets.NewCheckBox(th, &widget.Bool{Value: false}, "handler")
